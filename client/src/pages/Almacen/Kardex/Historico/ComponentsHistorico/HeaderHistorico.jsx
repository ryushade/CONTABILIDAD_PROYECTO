  ...
  return (
    <div className="headerHistorico">
      <div className="info">
        ...
        <p>
          Producto: 
          {productoData.length > 0 ? `${productoData[0].descripcion} - ${productoData[0].marca}` : ' Producto no registrado en el almacén seleccionado.'}
        </p>
        <p>
      ...
      <ButtonNormal onClick={handleGeneratePDFKardex} color={'#01BDD6'}>
    <MdOutlineLocalPrintshop className="inline-block text-lg" /> GUARDAR PDF
</ButtonNormal>
        <select 
