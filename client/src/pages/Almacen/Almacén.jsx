            ...
            <table class="w-full border-collapse mb-6 bg-white shadow-md rounded-lg overflow-hidden">
                ...
                <tbody>
                    ...
                    <tr class="bg-gray-50 hover:bg-gray-100">
                        <td class="border-b p-2 text-center">${item.codigo}</td>
                        <td class="border-b p-2 text-center">${item.descripcion}</td>
                        <td class="border-b p-2 text-center">${item.marca}</td>
                        <td class="border-b p-2 text-center">${item.stock}</td>
                        <td class="border-b p-2 text-center">${item.um}</td>
                    </tr>
                    `).join('')}
                </tbody>
            </table>
